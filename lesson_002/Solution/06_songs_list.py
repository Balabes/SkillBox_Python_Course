...
print('Три песни звучат ' + str(total_time) + ' минут')
...
total_time_others = violator_songs_dict['Sweetest Perfection'] + violator_songs_dict['Policy of Truth'] + \
                    violator_songs_dict['Blue Dress']
print('А другие три песни звучат ' + str(total_time_others) + ' минут')
