...
desks_quantity = store[goods['Стол']][0]['quantity'] + store[goods['Стол']][1]['quantity']
desks_cost = store[goods['Стол']][0]['quantity'] * store[goods['Стол']][0]['price'] + \
...
print('Стол -', desks_quantity, 'шт, стоимость', desks_cost, 'руб')
